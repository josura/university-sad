...
{
	const size_t nquarts_rows=nrows_T/4,nquarts_cols=ncols_T/4;
	const size_t gws[] = { round_mul_up(nquarts_cols, lws[0]), round_mul_up(nquarts_rows, lws[1]) };
	cl_event trans_evt;
	cl_int err;
...
int main(int argc, char *argv[])
{
	...
	const char *trans_kernel_name = "transpose_img_vect";
